...
export const SlideRenderer: React.FC<SlideRendererProps> = ({ slideIndex }) => {
  ...
  const renderContent = () => {
    switch (slideIndex) {
      case 0: // Title
        return (
          <div className="flex flex-col items-center justify-center h-full text-center space-y-4 sm:space-y-8 px-4">
            <motion.div
            ...
            >
              ...
              <h1 className="relative text-3xl sm:text-5xl md:text-6xl lg:text-8xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white via-cyan-100 to-gray-400 glow-text">
            ...
            <motion.h2
              ...
              className="text-sm sm:text-xl md:text-2xl lg:text-3xl text-gray-400 font-light tracking-widest uppercase"
            >
            ...
            <motion.div
              ...
              className="mt-6 sm:mt-12 p-4 border-t border-white/10"
            >
              <p className="text-gray-500 text-sm sm:text-base">Prepared by TalentlyX</p>
              <p className="text-cyan-500 text-xs sm:text-sm mt-2">26 November 2025</p>
            </motion.div>
          </div>
        );
      ...
      case 1: // Executive Summary
        return (
          <div className="h-full flex flex-col justify-center max-w-5xl mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 md:mb-12 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-white">Executive Summary</h2>
            <GlassCard>
      ...
      case 2: // Objectives
        return (
          <div className="h-full flex flex-col justify-center max-w-5xl mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 md:mb-12 border-b border-white/10 pb-4">Platform Objectives</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
              {[
                ...
                <GlassCard key={idx} className="flex items-center space-x-3 sm:space-x-4 p-3 sm:p-4">
                  <div className="p-1.5 sm:p-2 bg-cyan-500/10 rounded-lg flex-shrink-0">
                    <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 text-cyan-400" />
                  </div>
                  <span className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-200">{item}</span>
                </GlassCard>
              ))}
            </div>
          </div>
      ...
      case 3: // Key Features Overview
        ...
        return (
          <div className="h-full flex flex-col justify-center px-4">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-6 sm:mb-8 text-center">Key Features Overview</h2>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
              {features.map((f, i) => (
                <GlassCard key={i} className="flex flex-col items-center text-center hover:bg-white/10 transition-colors cursor-default p-3 sm:p-4">
                  <div className="p-2 sm:p-3 md:p-4 bg-gradient-to-br from-cyan-500/20 to-blue-600/20 rounded-full mb-2 sm:mb-3 md:mb-4">
                    {React.cloneElement(f.icon as React.ReactElement, { className: "w-5 h-5 sm:w-6 sm:h-6 md:w-8 md:h-8 text-cyan-300" })}
                  </div>
                  <h3 className="text-xs sm:text-sm md:text-base lg:text-lg font-bold text-white mb-1 sm:mb-2">{f.title}</h3>
  ...
  return (
    <motion.div
      ...
      className="h-full w-full p-4 sm:p-6 md:p-12 lg:p-16 flex flex-col relative z-10 overflow-y-auto"
    >
